...
{
    protected $examService, $categoryService, $gradeService, $scheduleService;

    public function __construct(GradeService $gradeService, ExamService $examService, CategoryService $categoryService, ScheduleService $scheduleService)
    {
