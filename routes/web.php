    ...
    Route::group(['prefix' => 'user', 'namespace' => '\App\Http\Controllers\User', 'as' => 'user.'], function() {
        ...
        Route::group(['namespace' => 'TryOut'], function() {
            ...
            // Route::resource('/categories', 'CategoryController')->only(['index']);
             Route::resource('/schedules/{id}/categories', 'CategoryController')->only(['index']);

            //exam
            Route::resource('schedules.categories.exams', 'ExamController')->only(['index', 'show']);
        ...
        Route::group(['namespace' => 'Transaction'], function() {
            ...
            Route::get('/transactions/{id}/print-exam-card', [\App\Http\Controllers\User\PrintController::class, 'printExamCard'])->name('transactions.print-exam-card');
