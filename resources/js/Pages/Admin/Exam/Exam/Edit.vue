                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select v-model="form.schedule_id" :class="{ 'is-invalid': errors.schedule_id }" class="form-select">
                                <option value="">[ Pilih ]</option>
                                <option v-for="(schedule, index) in schedules" :key="index" :value="schedule.id">{{ schedule.room.name + ' - ' + schedule.test_time + ' - ' + schedule.day  + ', ' + schedule.date  }}</option>
                            </select>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                schedule_id: props.exam.schedule_id,
