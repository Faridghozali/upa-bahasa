  ...
  setup({ el, App, props, plugin }) {
    createApp({ render: () => h(App, props) })
      ...
      .mixin({
        ...
        data() {
            return { 
              appName   : "UPA Bahasa Universitas Trunojoyo Madura" , 
              wa        : "0852 3220 9798", 
              copyright : "© Copyright 2025 TEAP. All Rights Reserved.",
              email     : "pusatbahasa@trunojoyo.ac.id",
              alamat    : "Gedung Cakra Lt. 5, Jl. Raya Telang PO BOX 2  Kamal - Bangkalan Madura" 
            }
        },
      })
      .use(plugin)
